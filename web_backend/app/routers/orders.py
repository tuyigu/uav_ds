...
from ..models import DeliveryOrderCreate, DeliveryOrder
...
def create_order(payload: DeliveryOrderCreate) -> DeliveryOrder:
    ...
    - 通过 RobotGateway 将任务发送给无人机 / ROS2 侧
    """
    order = DeliveryOrder(
